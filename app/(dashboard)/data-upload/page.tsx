...
export default function DataUploadTopPage() {
        ...
        <form className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="md:col-span-2 flex justify-end gap-4 mt-4">
            ...
            <button
              ...
              className="px-6 py-2 bg-blue-700 text-white rounded font-semibold"
            >
              {loading ? "OCR実行中..." : "OCR実行"}
            </button>
          </div>
        </form>
        <div className="mt-6 bg-gray-100 rounded p-4 min-h-[120px] whitespace-pre-wrap">
          {result ? result : "ここにOCR結果が表示されます"}
        </div>
      </div>
    </div>
  )
